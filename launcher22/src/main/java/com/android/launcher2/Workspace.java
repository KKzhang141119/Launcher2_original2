...
public class Workspace extends SmoothPagedView
    ...
    private void setPaper(int n)
    {
        int i = n;
        //修改默认背景 OWL test，可以在Framework替换默认静态图default_wallpaper

        WallpaperManager mwallpaerManager = mWallpaperManager;
        try
        {
           switch(i){
               case 0:
                   mwallpaerManager.setResource(R.drawable.wallpaper_01);
                   break;
               case 1:
                   mwallpaerManager.setResource(R.drawable.wallpaper_02);
                   break;
               case 2:
                   mwallpaerManager.setResource(R.drawable.wallpaper_03);
                   break;
               case 3:
                   mwallpaerManager.setResource(R.drawable.wallpaper_04);
                   break;
               case 4:
                   mwallpaerManager.setResource(R.drawable.wallpaper_05);
                   break;
               case 5:
                   mwallpaerManager.setResource(R.drawable.wallpaper_06);
                   break;
               case 6:
                   mwallpaerManager.setResource(R.drawable.wallpaper_07);
                   break;
               case 7:
                   mwallpaerManager.setResource(R.drawable.wallpaper_08);
                   break;
               case 8:
                   mwallpaerManager.setResource(R.drawable.wallpaper_09);
                   break;
               default:
                   mwallpaerManager.setResource(R.drawable.wallpaper_01);
                   break;
